...
public:
    ...
    void setupUi(QFrame *DonationOptionsFrame)
    {
        ...
        m_donationChangeAmountSpin->setDecimals(6);
        m_donationChangeAmountSpin->setMinimum(0.100000);
    ...
    void retranslateUi(QFrame *DonationOptionsFrame)
    {
        ...
        m_donationMiningCommentLabel->setText(QApplication::translate("DonationOptionsFrame", "Donation mining allows you to contribute a fixed share of your in-wallet mining profit to a Cobitcoin address of you choice.", 0));
