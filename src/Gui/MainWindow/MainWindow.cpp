...
const char COMMUNITY_FORUM_URL[] = "https://bitcointalk.org/index.php?action=profile;u=2095261";
const char REPORT_ISSUE_URL[] = "https://cobitcoin.io/#contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Cobitcoin Wallet %1").arg(Settings::instance().getVersion()));
