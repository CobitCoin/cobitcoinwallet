...
public:
    ...
    QAction *m_aboutCobitcoinAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/cobitcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutCobitcoinAction = new QAction(MainWindow);
        m_aboutCobitcoinAction->setObjectName(QStringLiteral("m_aboutCobitcoinAction"));
        m_aboutCobitcoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutCobitcoinAction);
        ...
        QObject::connect(m_aboutCobitcoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutCobitcoinAction->setText(QApplication::translate("MainWindow", "About Cobitcoin", 0));
...
#endif // QT_NO_TOOLTIP
        m_communityForumAction->setText(QApplication::translate("MainWindow", "Join us on Forum", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND COBITCOINS", 0));
